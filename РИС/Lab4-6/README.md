## Крч суть лабы в том, чтобы показать репликации бд между двумя (можно больше) серверами. Сдавалось Бернацкому, так что делали "как было задумано", а именно с той бд, которая описана в теории.
