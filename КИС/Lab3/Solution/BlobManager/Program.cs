...
public class Program
{
    ...
    private const string blobServiceEndpoint = "https://mediastornikita.blob.core.windows.net/";

    //Update the storageAccountName value that you recorded previously in this lab.
    private const string storageAccountName = "mediastornikita";

    //Update the storageAccountKey value that you recorded previously in this lab.
    private const string storageAccountKey = "WWcT6U9sHFLeoa2kjWmCY72t9M/tWeS+uhyL7op/k+ViMbKh63SnhnrFTyiouG1zHT+RnDjtMsOe+AStvtCFMQ==";    
